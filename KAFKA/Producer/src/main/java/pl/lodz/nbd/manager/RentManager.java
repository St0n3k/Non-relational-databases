...
public class RentManager {
    ...
    private RentProducer rentProducer = new RentProducer();

    public RentManager(ClientRepository clientRepository, RoomRepository roomRepository, RentRepository rentRepository) {
    ...
    public Optional<Rent> rentRoom(LocalDateTime beginTime, LocalDateTime endTime, boolean board, String clientPersonalId, int roomNumber) {
        ...
        Optional<Rent> optionalRent = rentRepository.add(rent);
        optionalRent.ifPresent(value -> rentProducer.produceRent(value));
        return optionalRent;
    }
